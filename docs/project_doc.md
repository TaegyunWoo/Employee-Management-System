...
## 시스템 WorkFlow
### 회원가입
![회원가입-workflow](./workflow/회원가입-WorkFlow.drawio.png)

<br/>

### 로그인
![로그인-workflow](./workflow/로그인-WorkFlow.drawio.png)

<br/>

### 직원정보
![직원정보-workflow](./workflow/직원정보-WorkFlow.drawio.png)

<br/>

### 직원등록
![직원등록-workflow](./workflow/직원등록-WorkFlow.drawio.png)
